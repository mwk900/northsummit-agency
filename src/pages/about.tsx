        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {[
              ...
              { icon: "🎯", title: "Built to bring in work", text: "Every element on your site is there to turn visitors into enquiries — not just look good." },
              ...
              { icon: "🔒", title: "You own everything", text: "Domain, hosting, code — all in your name. Nothing is ever tied to us. You can move or change anything at any time." },
            ].map((item) => (
