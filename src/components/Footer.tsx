        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              ...
              {/* Payment logos (tight under buttons, no padlock, no extra whitespace) */}
              <div className="mt-1">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  >
                    ...
                    <path
                      d="M23.4 7.7C22.9 7.5 22.1 7.3 21.2 7.3C18.9 7.3 17.3 8.5 17.3 10.2C17.3 11.5 18.4 12.2 19.3 12.6C20.2 13 20.5 13.3 20.5 13.7C20.5 14.3 19.8 14.6 19.1 14.6C18.1 14.6 17.6 14.4 16.8 14.1L16.5 13.9L16.2 16C16.8 16.3 17.9 16.5 19 16.5C21.5 16.5 23 15.3 23 13.5C23 12.5 22.4 11.8 21.1 11.2C20.3 10.8 19.8 10.6 19.8 10.1C19.8 9.7 20.2 9.3 21.1 9.3C21.9 9.3 22.4 9.5 22.8 9.7L23 9.8L23.4 7.7Z"
                      fill="white"
                    />
                    <path
                      d="M26.4 13.4C26.6 12.9 27.4 10.8 27.4 10.8C27.4 10.8 27.6 10.3 27.7 10L27.9 10.7C27.9 10.7 28.4 13 28.5 13.4H26.4ZM29.3 7.5H27.4C26.8 7.5 26.3 7.7 26.1 8.3L22.9 16.5H25.4C25.4 16.5 25.8 15.4 25.9 15.1H28.9C29 15.5 29.2 16.5 29.2 16.5H31.5L29.3 7.5Z"
                      fill="white"
                    />
                    <path
                      d="M14.1 7.5L11.8 13.4L11.6 12.4C11.1 11 9.8 9.4 8.4 8.6L10.5 16.5H13L16.6 7.5H14.1Z"
                      fill="white"
                    />
                    <path
                      d="M9.7 7.5H5.8L5.8 7.7C8.8 8.5 10.8 10.4 11.6 12.4L10.7 8.3C10.6 7.7 10.2 7.5 9.7 7.5Z"
                      fill="#F9A533"
                    />
                  </svg>
                  ...
                  >
                    ...
                    <path
                      d="M19 7.8C20.3 8.8 21.2 10.3 21.2 12C21.2 13.7 20.3 15.2 19 16.2C17.7 15.2 16.8 13.7 16.8 12C16.8 10.3 17.7 8.8 19 7.8Z"
                      fill="#FF5F00"
                    />
                  </svg>
{/* Apple Pay */}
