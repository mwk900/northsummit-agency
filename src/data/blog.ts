...
1. Can I see examples of websites you have built for trades or local businesses?
2. What is included in the price? (design, development, SEO setup, mobile optimisation)
3. Do I own the website and code when it is done?
...
Whatever you spend, make sure the site is mobile-friendly, has proper SEO foundations, loads quickly, and is designed to turn visitors into customers. That is what actually matters.`,
  ...
  {
    slug: "does-your-trade-business-need-a-website",
...
1. **A clear homepage** that says what you do, where you work, and how to get in touch
2. **A services page** listing what you offer
3. **A portfolio or gallery** showing your completed work
4. **A contact page** with a form, phone number, and email
5. **Mobile-friendly design** - because 70% of your customers are searching on their phones
...
That is what turns a website from a cost into an investment that pays for itself.`,
  ...
  {
    slug: "wix-vs-custom-website-for-trades",
...
**What Wix Costs:**
Wix plans for businesses start at around £13 per month (billed annually). Most tradespeople will need the Business plan or higher, which runs about £21 to £30 per month. That is roughly £250 to £360 per year including hosting and a free domain for the first year.
...
Business plans start at around £17 per month, going up to £43 per month for advanced ecommerce features. For a basic trades website, expect to pay around £200 to £300 per year.
...
WordPress itself is free. But you need hosting (£5 to £20 per month), a domain (£10 to £15 per year), and usually a premium theme (£30 to £80 one-off). If you hire a developer to build a WordPress site, expect to pay £500 to £5,000 depending on complexity.
...
For a small trades business in the UK, a custom-built website typically costs between £149 and £5,000 depending on the number of pages and features. A single-page site with a contact form might cost £149 to £500. A multi-page site with portfolio, SEO setup, and branding starts from around £349.
...
1. **Clear** - visitors know what you do and where within seconds
2. **Mobile-friendly** - works perfectly on phones
3. **Accessible** - phone number visible and clickable everywhere
4. **Authentic** - real photos, real reviews, real information
5. **Fast** - loads in under three seconds
6. **Trusted** - testimonials, qualifications, and certifications on display
7. **Findable** - built with SEO so Google can rank it for local searches
