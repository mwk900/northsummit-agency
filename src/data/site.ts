  ...
  pricing: [
    {
      ...
      originalPrice: '£249',
      popular: false,
      description: 'A professional single-page site for your business. Live in as little as 3 days.',
      features: [
        'Single-page responsive website',
        'Mobile-optimised design',
        'Contact form + Google Maps',
        'Technical SEO foundations',
        'Free audit of your current site',
    ...
    },
    {
      ...
      originalPrice: '£599',
      popular: true,
      description: 'For businesses that need more than one page - with proper branding, gallery, and analytics built in.',
      features: [
        'Up to 4 pages',
    ...
    },
    {
      ...
      originalPrice: '£1,199',
      popular: false,
      description: 'A full website with booking, blog, and everything set up to bring in work. 30 days of support after launch.',
      features: [
        'Up to 8 pages',
